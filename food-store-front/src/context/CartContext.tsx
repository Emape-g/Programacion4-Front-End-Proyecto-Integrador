...
export function CartProvider({ children }: { children: ReactNode }) {
  ...
  const value = useMemo(() => {
    ...
    return { items, count, total, addItem, updateQuantity, updatePersonalizacion, removeItem, clearCart };
  }, [items, addItem, updateQuantity, updatePersonalizacion, removeItem, clearCart]);
